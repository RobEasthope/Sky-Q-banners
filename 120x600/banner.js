...
function initDynamicContent() {
  ...
  devDynamicContent.Feed_120x600[0].reporting_label = "REPORTING_LABEL";
  ...
  devDynamicContent.Feed_120x600[0].youtubeId = "-Bpm35wZ0us";
  devDynamicContent.Feed_120x600[0].content = {
    "sprSheet_120x600_opt.jpg": {
      "Type": "file",
      "Url": "sprSheet_120x600_opt.jpg"
    },
  ...
  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['frame_1_copy.png']['Url'] + " id='frame_1_copy' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['frame_2_copy.png']['Url'] + " id='frame_2_copy' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['frame_3_copy.png']['Url'] + " id='frame_3_copy' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['ld_copy.png']['Url'] + " id='ld_copy' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['ld_cta.png']['Url'] + " id='ld_cta' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['sheen.png']['Url'] + " id='sheen' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['sky_glass_logo.png']['Url'] + " id='sky_glass_logo' class='images fade'></img>";

  document.getElementById("middle_container").innerHTML += "<img src=" + dynamicContent.Feed_120x600[0].content['sky_logo.png']['Url'] + " id='sky_logo' class='images fade'></img>";

  // create a new stage and point it at our canvas:
  stageP = new createjs.Stage(document.getElementById("testCanvas"));
  spriteSheet1 = new createjs.SpriteSheet({
    framerate: 20,
    "images": [dynamicContent.Feed_120x600[0].content['sprSheet_120x600_opt.jpg']['Url']],
    "frames": {
      "width": 120,
      "height": 600,
      "count": 330
...
function init() {
  ...
  var manifest = [{
    src: dynamicContent.Feed_120x600[0].content['frame_1_copy.png']['Url'],
    id: "frame_1_copy"
  }, {
    src: dynamicContent.Feed_120x600[0].content['ld_copy.png']['Url'],
    id: "ld_copy"
  }]
...
//    // LEGALS BUTTON:
//    this.container.innerHTML+="<div id='legalbtn' class='clicklegals'>"+dynamicContent.Feed_120x600[0].legalsButton+"</div>";
//    // LEGALS COPY:
//    this.container.innerHTML +="<div id='rollovercontent' class='legalscopy' style='max-height:"+(window.innerHeight-30)+"px;'>"+dynamicContent.Feed_120x600[0].legalsCopy+"</div>"
//
