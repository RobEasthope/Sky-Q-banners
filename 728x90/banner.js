...
function initDynamicContent() {
    ...
    devDynamicContent.Feed_728x90[0].reporting_label = "REPORTING_LABEL";
...
//    devDynamicContent.Feed_728x90[0].legalsCopy = "Comparison against Netflix and LOVEFiLM Instant using top 100 from UK box office over 12 months.  See sky.com\/blockbusters. On Demand: Available to Sky TV customers with compatible Sky+ box. Downloading content requires compatible black Sky+ box, broadband connection (minimum recommended speed 2 Mbps).  Content depends on your Sky TV\/HD subscription. \u00A9 2014 Disney Enterprises, Inc. All Rights Reserved. \u00A9 2014 Disney Enterprises, Inc. \u00A9 2015 Marvel .";
    ...
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['frame_1_copy.png']['Url']+" id='frame_1_copy' class='images fade'></img>";
    
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['frame_2_copy.png']['Url']+" id='frame_2_copy' class='images fade'></img>";
    
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['frame_3_copy.png']['Url']+" id='frame_3_copy' class='images fade'></img>";
    
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['ld_copy.png']['Url']+" id='ld_copy' class='images fade'></img>";
    
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['ld_cta.png']['Url']+" id='ld_cta' class='images fade'></img>";
    
    document.getElementById("middle_container").innerHTML+="<img src="+dynamicContent.Feed_728x90[0].content['sheen.png']['Url']+" id='sheen' class='images fade'></img>";
...
function init() {
    ...
    var manifest =  [
		{src:dynamicContent.Feed_728x90[0].content['frame_1_copy.png']['Url'], id:"frame_1_copy"},
		{src:dynamicContent.Feed_728x90[0].content['ld_copy.png']['Url'], id:"ld_copy"}
	]
...
function anim1EndHandler(){
    ...
    TweenLite.to(sky_logo,0.8,{delay:0, alpha:0});
...
//    // LEGALS COPY: 
//    this.container.innerHTML +="<div id='rollovercontent' class='legalscopy' style='max-height:"+(window.innerHeight-30)+"px;'>"+dynamicContent.Feed_728x90[0].legalsCopy+"</div>"
//
